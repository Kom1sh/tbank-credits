...
S.append(slide(top("Досрочное погашение") + '<h1>Гасить досрочно стоит не всегда</h1>'
  '<div class="body">'
  '<div class="cond" style="margin-bottom:18px">'
  '<div><b>4 000 000 ₽</b><span>сумма кредита</span></div>'
  '<div><b>20 лет</b><span>срок по договору</span></div>'
  '<div><b>+20 000 ₽</b><span>свободных денег в месяц</span></div>'
  '<div><b>12,95%</b><span>ставка вклада, ЦБ, сентябрь 2026</span></div>'
  '</div>'
  '<div class="g2" style="margin-bottom:16px">'
  + mcase("grey", "Базовая ипотека, 16,9%",
          "58 400 ₽",
          [("проценты банку, если платить все 20 лет", "10,0 млн ₽"),
           ("с доплатой 20 000 ₽ кредит закрыт за", "7 лет 7 мес"),
  ...
  + mcase("grey", "Семейная ипотека, 6%",
          "28 700 ₽",
          [("проценты банку, если платить все 20 лет", "2,9 млн ₽"),
           ("с доплатой 20 000 ₽ кредит закрыт за", "8 лет 11 мес"),
           ("проценты в этом случае", "1,2 млн ₽"),
           ("на руках через 20 лет: гасить досрочно", "14,5 млн ₽"),
           ("на руках через 20 лет: копить на вкладе", "22,5 млн ₽")],
          "Вклад выигрывает 8,0 млн ₽", "bad")
  + '</div>'
  + '<div class="rule" style="padding:16px 26px;margin-bottom:auto"><span class="f" style="font-size:26px">Сравнивайте ставку кредита со ставкой вклада: <b>16,9% &gt; 12,95%</b> — гасите, <b>6% &lt; 12,95%</b> — копите</span>'
    '<span class="n">Расход в месяц в обоих случаях одинаковый, квартира одна и та же. Налог на проценты по вкладу не учитываем.</span></div></div>', "Досрочное погашение"))
