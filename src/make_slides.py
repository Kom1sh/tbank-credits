...
S.append(slide(top("Линейка и правило") + '<h1>Порог сегодня — 6–8% годовых. Из линейки его проходят два продукта</h1>'
  ...
  '<p class="foot">Условия со страниц tbank.ru, сняты 22 сентября 2026. В линейке есть ещё образовательный кредит, рефинансирование и кредит под залог. Сравнивать продукты можно только по ПСК: у автокредита банк её раскрывает, у кредита наличными — нет.</p></div>', "Линейка и правило"))
...
S.append(slide(top("Досрочное погашение") + '<h1>Гасить досрочно стоит не всегда: на льготной ипотеке это проигрыш</h1>'
  '<div class="body"><div class="g2" style="margin-bottom:18px">'
  + mcase("grey", "Базовая ипотека, 16,9%",
          "58 400 ₽",
          [("проценты банку, если платить 20 лет", "10,0 млн ₽"),
           ("если добавлять 20 000 ₽ в месяц", "закрыта за 7 лет 7 мес"),
           ("проценты в этом случае", "3,1 млн ₽"),
           ("на руках через 20 лет: гасить досрочно", "28,8 млн ₽"),
           ("на руках через 20 лет: копить на вкладе", "22,5 млн ₽")],
          "Досрочное погашение выигрывает 6,3 млн ₽", "good")
  + mcase("grey", "Семейная ипотека, 6%",
          "28 700 ₽",
          [("проценты банку, если платить 20 лет", "2,9 млн ₽"),
           ("если добавлять 20 000 ₽ в месяц", "закрыта за 8 лет 11 мес"),
           ("проценты в этом случае", "1,2 млн ₽"),
           ("на руках через 20 лет: гасить досрочно", "14,5 млн ₽"),
           ("на руках через 20 лет: копить на вкладе", "22,5 млн ₽")],
          "Вклад выигрывает 8,0 млн ₽", "bad")
  + '</div>'
  + '<div class="rule" style="padding:18px 26px;margin-bottom:auto"><span class="f" style="font-size:27px">Сравнивайте ставку кредита со ставкой вклада: <b>16,9% &gt; 12,95%</b> — гасите, <b>6% &lt; 12,95%</b> — копите</span></div>'
  '<p class="foot">Расчёт: кредит 4 млн ₽ на 20 лет, свободные 20 000 ₽ в месяц, вклад под 12,95% — средняя максимальная ставка топ-10 банков, Банк России, первая декада сентября 2026. В обоих сценариях расход в месяц одинаковый, квартира одна и та же, поэтому её подорожание на сравнение не влияет. Без учёта налога на проценты по вкладу.</p></div>', "Досрочное погашение"))
...
S.append(slide(top("Зачем занимают, когда деньги есть") + '<h1>Долг увеличивает и прибыль, и убыток. Работает, только если отдача выше ставки</h1>'
  ...
  + '</div>'
  + '<div class="rule" style="padding:18px 26px"><span class="f" style="font-size:27px">Занимать имеет смысл, пока отдача <b>заметно выше</b> ставки: разница и есть заработок на чужих деньгах</span></div>'
  + '</div>'
  ...
  + '<div class="card"><div class="stat sm"><div class="n">25,7 <small>→</small> 76 <small>млрд $</small></div><div class="l">столько банк Morgan Stanley выдал клиентам под залог их ценных бумаг: 25,7 млрд в марте 2016 года и около 76 млрд в 2021‑м</div></div></div>'
  + '</div></div><p class="foot">Проценты и доли — учебный расчёт, а не обещание доходности. Данные Morgan Stanley — отчётность в Комиссию по ценным бумагам США и отраслевые обзоры; практику залога вместо продажи описывает J.P. Morgan.</p></div>', "Рычаг и залог"))
